...
import {Card, Text, Button, Badge, Divider, CloseButton} from '@mantine/core'; // Importing Badge for displaying completion status
                    ...
                    >
                        ...
                        <div style={{display: 'flex', justifyContent: 'space-between', marginTop: '16px'}}>
                            ...
                            <Auth capability="delete">
                                <CloseButton onClick={() => props.deleteItem(item.id)}/>
                            < /Auth>
                        </div>
                    </Card>
            ))}
